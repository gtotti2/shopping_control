...
function setList(list){
	...
	for(var key in list){
		table += '<tr><td>' + formatDesc(list[key].desc) + '</td><td>' + formatValue(list[key].value) + '</td><td>' + formatAmount(list[key].amount) + '</td><td><button class="btn btn-default" onClick="setUpdate('+ key +');">Edit</button>   <button class="btn btn-default" onClick="deleteData('+ key +');">Delete</button></td></tr>'
	}
	table += '</tbody>';
	if(list != ""){
